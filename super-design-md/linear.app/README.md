...
Use [DESIGN.md](https://github.com/Eldergenix/SUPER-DESIGN/blob/main/super-design-md/linear.app/DESIGN.md) to use as a reference for AI agents (Claude, Cursor, Stitch) to generate UI that looks like the Linear design language.
